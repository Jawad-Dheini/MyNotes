package com.jawad.mynotes1.adapters;
...
import com.jawad.mynotes1.activities.MainActivity;
    ...
    static class NoteViewHolder extends RecyclerView.ViewHolder {
        ...
        void setNote(Note note) {
            ...
            if(!note.getImagePath().equals("")) {
                    ...
                    original.compress(Bitmap.CompressFormat.JPEG, 8, baos);
                    Bitmap decoded = BitmapFactory.decodeStream(new ByteArrayInputStream(baos.toByteArray()));

                    imageNote.setImageBitmap(decoded);
